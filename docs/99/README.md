...
스프링 시큐리티의 oauth2Login의 간단한 구현은 [여기](https://github.com/boyd-dev/demo-security/blob/main/docs/06/README.md)를 참조하면 되겠습니다. 이 예제에서는 단순하게 인증만 하고 별도의 토큰을 발행하지 않습니다. 이 말은 인증 후에는 사용자 세션을 만든다는 말이 되겠습니다(로그아웃하면 액세스 토큰을 폐기하고 세션을 삭제합니다).
